...
double Ki = 1.5; // gain intégral du PID
...
void CommandeMoteurDroit(double commande, double tensionAlim) {
    ...
    tension_int = (int)(400 * (tension / tensionAlim));
