...
class MPU9250:
    ...
    def configMPU9250(self, gfs, afs):
        ...
        # A_DLPFCFG
        self.bus.write_byte_data(self.address, ACCEL_CONFIG_2, 0x06)
        # BYPASS_EN
    ...
    def configAK8963(self, mode, mfs):
        ...
        # BYPASS_EN
        # La ligne suivante est en commentaire sinon ça ne fonctionne pas
    ...
    def readMagnet(self):
        ...
        # check data ready
        # Ci-dessous, on ne teste pas si les données sont prêtes car si elles
        # ne le sont pas, la fonction retourne 0.
        # Dans le cas contraire (sans le test), la fonction retourne les valeurs
        # précédentes si les données ne sont pas prêtes.
